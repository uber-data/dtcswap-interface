...
import { JSBI, Token, TokenAmount, WETH, Fraction, Percent, CurrencyAmount } from 'dtcswap-sdk'
  ...
  const liquidityToken: Token | undefined = useMemo(
    () =>
      validatedAddress && chainId && token
        ? new Token(chainId, validatedAddress, 18, `DTC-V1-${token.symbol}`, 'DTCSwap V1')
        : undefined,
    ...
    <BodyWrapper style={{ padding: 24 }} id="remove-v1-exchange">
      <AutoColumn gap="16px">
        <AutoRow style={{ alignItems: 'center', justifyContent: 'space-between' }} gap="8px">
          ...
          <div>
            <QuestionHelper text="Remove your DTCSwap V1 liquidity tokens." />
          </div>
        </AutoRow>
